...
print('\x1b[1;33m══════════════════')
print('')
print('\x1b[2;32m________________')
print('')
print('\x1b[1;31m1 - ابلاغات عشوائيـة ')
print(('\033[92m—'*25)+'\n DeCoDe By @vipQvup\n'+('—'*25))
print('\x1b[2;32m________________')
print('')
print('\x1b[1;31m2 - ابلاغ محـدد ')
print('\x1b[2;32m________________')
print(('\033[92m—'*25)+'\n DeCoDe By @vipQvip\n'+('—'*25))
print('')
print('\x1b[1;33m══════════════════')
print('')
comra = input('\x1b[1;36m اختـاࢪ واحد : \x1b[0m')
if comra == '1':
    time.sleep(1)
    print('\n1 - انتحال \n2 - خطاب الكراهية\n3 - العنف ، الانتحار \n')
    time.sleep(1)
    print(' بلاغـات عشوائية ....')
    time.sleep(1)
    print('')
    id1 = input('\x1b[1;36mحط يوزر الضحـية >> : ')
    print('\x1b[1;31mجاري البـدء...')
    ...
    data3 = {
        ...
        'report_type': 'user' }
    time.sleep(2)
    req1 = requests.post(url1, data1, headers1, **('json', 'headers')).text
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
        print('\x1b[1;92mتـم ارسـال ابلاغ انتحال')
    else:
        print('\x1b[0;92mتـم ارسـال ابلاغ انتحال')
    time.sleep(2)
    req2 = requests.post(url2, data2, headers2, **('json', 'headers')).text
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
        print('\x1b[1;92mتـم ارسـال ابلاغ خطاب يحض على الكراهية')
    else:
        print('\x1b[0;92mتـم ارسـال ابلاغ خطاب الكراهية')
    time.sleep(2)
    req3 = requests.post(url3, data3, headers3, **('json', 'headers')).text
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
        print('ارسلت ابـلاغ انتحار')
    else:
        print('\x1b[0;92mلقـد ارسلت ابلاغ انتحـار، عنف')
    

if comra == '2':
    print('\n1 - انتحال \n2 - خطاب الكراهية\n3 - العنف ، الانتحار \n')
comra2 = input('\x1b[1;92mاختاࢪ : \x1b[0m')
if comra2 == '1':
    username = input('\x1b[1;92mيوزر الضحيـة >> : \x1b[0m')
    ...
    data5 = {
        ...
        'report_type': 'user' }
    time.sleep(2)
    req5 = requests.post(url5, data5, headers5, **('json', 'headers')).text
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req5:
        print('\x1b[1;92mتـم ارسـال الابلاغ')
    else:
        print('\x1b[0;92mابلاغ')
    
if comra2 == '2':
    username2 = input('\x1b[1;92mيوزر الضحيـة >> : \x1b[0m')
    ...
    data6 = {
        ...
        'report_type': 'user' }
    time.sleep(2)
    req6 = requests.post(url7, data6, headers6, **('json', 'headers')).text
...
if comra2 == '3':
    username3 = input('\x1b[1;92mيوزر الضحيـة >> : \x1b[0m')
    ...
    data30 = {
        ...
        'report_type': 'user' }
    time.sleep(2)
    req600 = requests.post(url30, data30, headers30, **('json', 'headers')).text
    if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req600:
        print('\x1b[1;32mتم ارسال الابلاغ ')
    else:
        print('\x1b[0;31mللاسف بلاغ فاشل')
